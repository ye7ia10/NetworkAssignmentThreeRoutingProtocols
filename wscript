...
def build(bld):
    ...
    obj = bld.create_ns3_program('first', ['core', 'point-to-point', 'internet', 'applications','netanim'])
    obj.source = 'first.cc'
    ...
    obj = bld.create_ns3_program('first', ['assign3', 'point-to-point', 'internet', 'applications','netanim'])
    obj.source = 'assign3.cc'
